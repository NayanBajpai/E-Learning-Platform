...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="acharya.jpg" width="60" height="70" >       Acharya Instititute Of Technology <br>Information Science
      <p class="subtitle"> Mini-Learn </p> 
  </div>
</section> 
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color:#342D7E ; color:#fff;">
              <p align="left">&copy; ACHARYA INSTITUTE OF TECHNOLOGY</p>
     </footer>
 </section>
