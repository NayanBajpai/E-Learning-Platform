...
<title><?php echo $title;?>  | ACHARYA MINI-LEARN</title>
...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="mini-learn.png" width="45" height="45">Acharya Institute Of Technology <br>Mini-Learn
      <br>Bangalore
      <p class="subtitle"> INFORMATION SCIENCE</p> 
  </div>
</section>  
