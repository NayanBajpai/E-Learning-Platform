...
<style type="text/css">
  .login100-more img {
    width: 100%;
    height: 100%;
    background-image: url('adminMenu/images/login.jpg');
...
<!-- 
        ...
        <div class="login100-more">
          <img src="adminMenu/images/login2.jpg" style="object-fit: contain ">
        </div>
      </div>
    </div>
  </div>
...
if(isset($_POST['btnLogin'])){
  ...
  //it creates a new objects of member
    ...
    if ($res==true) {
       message("You've succesfully logged in as an ".$_SESSION['TYPE'].".","success");
