...
switch ($action) {
	...
	function doInsert(){
		...
		if(isset($_POST['save'])){
			...
			foreach ($cur as $result) { 
				$sql = "INSERT INTO studentquestion (`ExerciseID`, `LessonID`, `StudentID`,`Question`, `CA`, `CB`, `CC`, `CD`, `QA`) 
	...
	if(isset($_POST['save'])){
			...
			$sql = "UPDATE studentquestion SET   `LessonID`='".$_POST['Lesson']."', `Question`='".$_POST['Question']."', `CA`='".$_POST['ChoiceA']."', `CB`='".$_POST['ChoiceB']."', `CC`='".$_POST['ChoiceC']."', `CD`='".$_POST['ChoiceD']."', `QA`='".$_POST['Answer']." WHERE ExerciseID='{$id}'";
			$mydb->setQuery($sql);
			$mydb->executeQuery();
	...
	function doDelete(){
		...
		global $mydb;
				...
				$sql = "DELETE FROM studentquestion  WHERE ExerciseID='{$id}'";
				$mydb->setQuery($sql);
				$mydb->executeQuery();
