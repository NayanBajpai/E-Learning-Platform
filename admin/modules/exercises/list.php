...
?>
    <div class="row">
      <div class="col-lg-12"> 
            <h1 class="page-header">List of Questions <small>|  <label class="label label-xs" style="font-size: 12px"><a href="index.php?view=add">  <i class="fa fa-plus-circle fw-fa"></i> New</a></label> |</small></h1> 
        	...
        	<!-- /.col-lg-12 -->
				...
				<table id="example" class="table table-bordered table-hover" cellspacing="0" style="font-size:12px" >
				  ...
				  <tbody>
				  	<?php  
				  		$mydb->setQuery("SELECT * FROM `lesson` l, `exercise` e WHERE l.`LessonID`=e.`LessonID`");
